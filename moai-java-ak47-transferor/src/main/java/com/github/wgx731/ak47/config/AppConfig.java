...
public class AppConfig {
    ...
    @Bean
    Queue queue() {
        return new Queue(MessageQueueConst.TRIGGER_TRANSFER_QUEUE, false);
    }
    ...
    Binding binding(Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(MessageQueueConst.TRIGGER_TRANSFER_QUEUE);
    }
    ...
    SimpleMessageListenerContainer container(ConnectionFactory connectionFactory,
        ...
        container.setQueueNames(MessageQueueConst.TRIGGER_TRANSFER_QUEUE);
